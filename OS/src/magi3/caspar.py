"""
MAGI OS v2 — MAGI-3 Caspar: Fusion & Decision Node
src/magi3/caspar.py
...
class Caspar(LifecycleNode):
    ...
    def on_configure(self):
        ...
        self.log.info("Caspar configured")
    ...
    def on_activate(self):
        self.log.info("Caspar active — decision loop running")
    ...
    def _fuse_and_decide(self):
        ...
        # Diagnostics
        self.publish_diag(DiagStatus.OK, f"Decision={action}",
                          {"action": action, "priority": priority, "decisions": self._decision_count})
...
if __name__ == "__main__":
    Caspar(node_id="magi3", cpu_core=3).boot()
